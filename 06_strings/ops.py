...
if mobile_num.startswith("+91"):
    ...
    print("Calling spport available only to India, USA & China")
...
emp_row = "John,Hyd,25,John@gmail.com,Developer"
print("Original Data: "+emp_row)

fields = emp_row.split() # ['John,Hyd,25,John@gmail.com,Developer']
print(fields)
fields = emp_row.split(",") # ['John', 'Hyd', '25', 'John@gmail.com', 'Developer']
print(fields)
