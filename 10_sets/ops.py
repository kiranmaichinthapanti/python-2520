...
backup.pop()
print(backup)
print(s1) # object is same for both
...
# difference_update() : removes the elements and update calling set
s1 = {10,20,30,40,50}
s2 = {40,50,60,70,80}
...
# symmetric_difference() : removes the common elements and takes the combined elements left in both
s1 = {10,20,30,40,50}
s2 = {40,50,60,70,80}
print(s1.symmetric_difference(s2))
print(s1 ^ s2)

# symmetric_difference_update() : removes the common elements and takes the combined elements left in both, and update calling set
s1 = {10,20,30,40,50}
s2 = {40,50,60,70,80}
