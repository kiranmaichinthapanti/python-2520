...
# Deleting the student via function
def delete_student():
    print("Deleting Student Logic")
    student_id = input("Enter ID To Delete: ")
    if student_id in students:
        remove_id = students.pop(student_id)
        print("student deleted: ",remove_id)
    else:
        print("ID is not Exist to delete")

    # for our confirmation
    print(students)

# read students via function
def read_students():
...
def search_students():
    ...
    if filtered_students:
        print(f"Studnets With Skills {skill_to_search}: ")
